...
class Http extends SwooleEvent
{
    ...
    {
        file_put_contents(WEB_TMP_PATH . $this->setting['master_pid_file'], $server->master_pid);
        file_put_contents(WEB_TMP_PATH . $this->setting['manager_pid_file'], $server->manager_pid);
